...
class DDMD(nn.Module):
    ...
    def _compute_kl_grad(
        ...
        return grad, grad_ca, grad_dm, {
            ...
            "timestep_dm": timestep_dm.detach(),
            "timestep_ca": timestep_ca.detach(),
        }
    ...
    def compute_distribution_matching_loss(
        ...
        with torch.no_grad():
            # Step 1: Randomly sample timestep_ca and timestep_dm based on the given schedule and corresponding noise
            timestep_dm = torch.randint(
                0,
