from causvid.models.wan22.wan_base.modules.attention import attention
from causvid.models.wan22.wan_base.modules.model import (
    WanRMSNorm,
    rope_apply,
    WanLayerNorm,
    WanCrossAttention,
...
class CausalWanModel(ModelMixin, ConfigMixin):
    ...
    def __init__(self,
        ...
        self.blocks = nn.ModuleList([
            CausalWanAttentionBlock(dim, ffn_dim, num_heads, window_size, qk_norm,
    ...
    def _prepare_blockwise_causal_attn_mask(
        device: torch.device | str, num_frames: int = 30,
